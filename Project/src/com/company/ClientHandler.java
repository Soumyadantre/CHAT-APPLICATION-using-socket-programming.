...
public class ClientHandler implements Runnable {
    ...
    private BufferedReader bufferedReader; // To read message from other client
    private BufferedWriter bufferedWriter; // to write the message to other clients we have received from any client
    private String clientUsername;  // used to represent clients
